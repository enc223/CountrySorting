 ...
 * HW3*/
public class ComparatorByName implements Comparator <Country>{//will access country.java
	public int compare(Country code1, Country code2) {//takes in teh countries
		String f1=code1.getName();//gets area
		String f2=code1.getName();//gets area
